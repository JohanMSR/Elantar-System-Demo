...
<body>
    @php
      ...
      //  $precal->c2_fe_fecha_nacimiento = Carbon::parse($precal->c2_fe_fecha_nacimiento)->format('m/d/Y');
        $precal->c2_fe_fecha_nacimiento = !empty($precal->c2_fe_fecha_nacimiento) 
        ? Carbon::parse($precal->c2_fe_fecha_nacimiento)->format('m/d/Y')  : '';
        $precal->fe_vencimto_lic = Carbon::parse($precal->fe_vencimto_lic)->format('m/d/Y');
        if(!empty($precal->c2_fe_vencimto_lic)){
    ...
    <table>
        <tr class="section-title">
            <th colspan="4">Personal And Bank References / Referencias Personales y Bancarias</th>
        </tr>
        <tr>
            <td colspan="2">
                <div class="div-title">
                    ...
                    <table style="width: 100%; border-collapse: collapse; border: none;">
                        <tr>
                            <td style="width: 50%; text-align: left; vertical-align: middle; border: none; padding: 0;">
                                {{$precal->tx_numero_ruta}}
                            </td>
                            <td style="width: 50%; text-align: right; vertical-align: middle; font-size: 9pt; border: none; padding: 0;">
                                @if($precal->co_tipo_cuenta && $precal->co_tipo_cuenta == '1')
                                    <div>Savings (x)</div>
                                    <div>Checking()</div>
                                @elseif($precal->co_tipo_cuenta && $precal->co_tipo_cuenta == '2')
                                    <div>Savings ()</div>
                                    <div>Checking(x)</div>
                                @endif
                            </td>
