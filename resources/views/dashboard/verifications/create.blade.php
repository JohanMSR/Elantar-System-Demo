...
@section('title')
Crear Verificación - @lang('translation.business-center')
@endsection
...
@section('content')
    ...
    @php
        $verificationsTitle = 'Crear Verificación';
    @endphp
    <x-page-header :title="$verificationsTitle" icon="plus-square" :has_team="false" />
    <br>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="section-title">Nueva Verificación</h5>
                        <p class="text-muted">Crear un nuevo requerimiento de verificación</p>
                    </div>
                ...
                <div class="dashboard-card fade-in">
                    <div class="card-header-custom">
                        <div>
                            ...
                            <p class="card-subtitle">Complete los datos de la nueva verificación</p>
                        </div>
                    </div>

                    <form action="{{ route('verifications.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input @error('water_types') is-invalid @enderror" 
                                                   ...
                                                   {{ in_array($waterType->co_tipo_agua, old('water_types', [])) ? 'checked' : '' }}>
