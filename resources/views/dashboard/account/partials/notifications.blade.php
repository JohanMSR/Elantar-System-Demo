                ...
                <div class="notification-meta">
                    <span class="notification-time">
                        ...
                        <span data-time="{{ $notification->fe_registro }}">
                            @php
                                $fecha = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $notification->fe_registro);
                            @endphp
                            {{ $fecha->format('m/d/Y') }} {{ $fecha->format('H:i:s') }}
...
$(document).ready(function() {
    $('.badge_').on('click', function() {
        var parentDiv = $(this).closest('.notification-item');
        var newContent = `
            <div class="d-flex">
                <div class="notification-icon-wrapper">
                ...
                <div class="notification-content">
                    <h6 class="notification-title">
                        Notificación
                        <span class="badge bg-primary" style="font-size: 0.7rem; vertical-align: middle;">Nueva</span>
                    </h6>
                    <p class="notification-message">
        ...
        feather.replace(); // Reemplazar los íconos de Feather
    });
});
</script>
