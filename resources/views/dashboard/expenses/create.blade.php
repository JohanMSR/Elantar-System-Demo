...
@section('title')
Crear Gasto - @lang('translation.business-center')
@endsection
...
@section('content')
    ...
    @php
        $expensesTitle = 'Crear Gasto';
    @endphp
    <x-page-header :title="$expensesTitle" icon="plus-square" :has_team="false" />
    <br>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="section-title">Nuevo Gasto</h5>
                        <p class="text-muted">Crear un nuevo gasto</p>
                    </div>
                ...
                <div class="dashboard-card fade-in">
                    <div class="card-header-custom">
                        <div>
                            ...
                            <p class="card-subtitle">Complete los datos del nuevo gasto</p>
                        </div>
                    </div>
