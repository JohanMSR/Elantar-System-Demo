...
@section('title')
Editar Gasto - @lang('translation.business-center')
@endsection
...
@section('content')
    ...
    @php
        $expensesTitle = 'Editar Gasto';
    @endphp
    <x-page-header :title="$expensesTitle" icon="edit" :has_team="false" />
    <br>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="section-title">Editar Gasto</h5>
                        <p class="text-muted">Modificar la información del gasto</p>
                    </div>
                ...
                <div class="dashboard-card fade-in">
                    <div class="card-header-custom">
                        <div>
                            ...
                            <p class="card-subtitle">Modifique los datos del gasto</p>
                        </div>
                    </div>

                    <form action="{{ route('expenses.update', $expense) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="cost-input-group">
                                        <input type="number" class="form-control @error('estimated_cost') is-invalid @enderror" 
                                               id="estimated_cost" name="estimated_cost" value="{{ old('estimated_cost', $expense->estimated_cost) }}" 
