...
class UpdatePrecalificacionRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'tx_url_img_photoid_c1' => 'nullable|image|min:1|max:30720|mimes:jpeg,jpg,gif,png,webp',
            ...
            'tx_ciudad_trab_c1' => 'nullable|required_if:co_metodo_pago_proyecto,2|min:3|string|max:255',
           ...
           // 'tx_url_img_photoid_c2' => 'nullable|image|min:1|max:30720|mimes:jpeg,jpg,gif,png,webp',
           'tx_url_img_photoid_c2' => [
               'nullable',
                function ($attribute, $value, $fail) {
                    if ($this->bo_co_signer === true && 
                        empty($this->tx_url_img_photoid_c2_old) && 
                        empty($value)) {
                        $fail('La foto del co-firmante es requerida');
                    }
                },
                'image',
                'mimes:jpeg,jpg,gif,png,webp',
                'max:30720',
                'min:1'
            ],
            ...
            'tx_ciudad_trab_c1' => 'nullable|string|max:255',
            'tx_ciudad_trab_c2' => 'nullable|string|max:255',

            // Campos ocultos
            'tx_url_img_signature_c1_old' => 'nullable|string',
            'tx_url_img_signature_c2_old' => 'nullable|string',
            'tx_url_img_photoid_c1_old' => 'nullable|string',
            'tx_url_img_photoid_c2_old' => 'nullable|string',
            'co_qb_id_proyecto' => 'nullable|string',
            'urldestination' => 'nullable|string',
            'tx_url_orden_trabajo' => 'nullable|string',
    ...
    public function messages()
    {
        return [
            ...
            'tx_social_security_number_c1.required_if' => 'El número de seguro social es requerido.',
            'tx_social_security_number_c1.digits' => 'El número de seguro social debe ser un valor con 9 digitos.',
            'tx_licencia_c1.required_if' => 'La licencia es requerida.',
            ...
            'fe_vencimto_licencia_c1.required_if' => 'La fecha de vencimiento de la licencia es requerida.',
            ...
            'co_aplicacion.required' => 'El codigo de la aplicacion es requerido.',
            'co_aplicacion.numeric' => 'El codigo de la aplicacion debe ser un número entero.',
            'tx_url_img_photoid_c2.image' => 'El archivo debe ser una imagen.',
            'tx_url_img_photoid_c2.mimes' => 'La imagen debe ser de tipo: jpeg, png, jpg.',
            'tx_url_img_photoid_c2.max' => 'La imagen no debe ser mayor a 3MB.',
