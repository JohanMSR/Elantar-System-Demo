...
{
    protected $storagePath = 'app_documents';
    
    public function uploadDocument(Request $request, $fieldName, $app,$document)
    {
        $rutaDestino = '';
        try {
            if ($request->hasFile($fieldName)){
                ...
                {   
                    ...
                    $lastName = Str::afterLast($fieldName, '_');
                    if(strtolower($extension) === 'pdf'){
                        $nombre_temp = $app.'_'.$lastName.'.'.$file->getClientOriginalExtension();
