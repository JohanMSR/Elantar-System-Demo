...
class TeamOnlyProjects extends Model implements Projects
{
    use HasFactory;
    protected $total;
    ...
    public function getAnalyst()
    {
        ...
        select * from equipo where equipo.co_usuario <> $co_usuario_logueado order by equipo.analista ASC";
    ...
    public function getProjects(Request $request)
    {
        ...
        $sql = "WITH RECURSIVE equipo(co_usuario, analista) AS (
            ...
            WHERE   ((ap1.co_usuario   IN (SELECT equipo.co_usuario from equipo where equipo.co_usuario != $co_usuario_logueado))  
            OR  (ap1.co_usuario_2 IN (SELECT equipo.co_usuario from equipo where equipo.co_usuario != $co_usuario_logueado))) "; 
